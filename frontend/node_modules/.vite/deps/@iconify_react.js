...
import { t as require_react } from "./react-5eFYziw5.js";
...
function listIcons(provider, prefix) {
	...
	(typeof provider === "string" ? [provider] : Object.keys(dataStorage)).forEach((provider$1) => {
		(typeof provider$1 === "string" && typeof prefix === "string" ? [prefix] : Object.keys(dataStorage[provider$1] || {})).forEach((prefix$1) => {
			const storage$1 = getStorage(provider$1, prefix$1);
			allIcons = allIcons.concat(Object.keys(storage$1.icons).map((name) => (provider$1 !== "" ? "@" + provider$1 + ":" : "") + prefix$1 + ":" + name));
		});
	});
	return allIcons;
}
